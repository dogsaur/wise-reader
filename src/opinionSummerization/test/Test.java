...
public class Test {
	public static void main(String[] args) {
		...
		public static String test_text1 = 
					"自从2015年年中以来，中国股民经历了过山车，而且不是一次两次，猴年未到看猴市先行。就在这一轮一轮暴涨暴跌之中，关于证监会主席的去留传言始终不断。结果，谣言又成了遥遥领先的预言，证监会的肖刚时代在一片质疑声中黯然落幕。";
		...
		public static String test_text3 = 
					"经济发展趋势，接受记者采访的经济学家普遍认为，2016年仍将继续探底，稳增长面临较大压力，经济走势或呈现前低后高的局面。央行货币政策委员会委员樊纲、中信证券首席经济学家诸建芳表示，我国经济还在这一轮周期的低谷当中运行，还没有完全到达底部，2016年经济还在继续下行。";
}
